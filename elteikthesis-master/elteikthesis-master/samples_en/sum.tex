...
\textbf{Out-of-scope refusal.} Only \texttt{llama3.2:3b} with RAG declines out-of-scope questions, and only 20\% of the time. \texttt{gemma3:4b} does not refuse at all, falling back on parametric knowledge instead. A more robust refusal mechanism — such as a retrieval-score threshold below which the system returns a fixed ``I don't know'' response — is needed for a production deployment.
