...
\noindent\textbf{Important:} \texttt{EMBEDDING\_MODEL} must not be changed after notebook~02 has been run. A mismatch between the query encoder and the stored index produces incorrect retrieval results.
