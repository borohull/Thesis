...
\begin{itemize}
    ...
    \item \textbf{Docker}, a containerisation platform, packages the entire
        ...
        Each service is defined in a \texttt{docker-compose.yml} file, so the full
        stack starts with a single command and requires no manual dependency
        installation. This makes it the mechanism behind the deployability
