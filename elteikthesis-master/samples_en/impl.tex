...
All development and testing was performed on the machine specified in
Table~\ref{tab:dev-machine}, which matches the target hardware profile
defined in the resource constraint (R-NF-2).
...
\label{sec:impl-embedding-model}
