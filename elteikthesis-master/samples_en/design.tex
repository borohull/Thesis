...
Figure~\ref{fig:class-diagram} shows the module structure of the application and the dependencies between them.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{images/ClassDiagram.png}
    \caption{Class diagram of the ELTE IK Assistant application modules.}
